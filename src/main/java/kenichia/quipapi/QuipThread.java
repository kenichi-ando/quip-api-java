...
public class QuipThread extends QuipJsonObject {
    ...
    JsonObject json =
        _getToJsonObject(
            new URIBuilder(QuipAccess.ENDPOINT + "/threads/")
                .addParameter("ids", Stream.of(threadIds).collect(Collectors.joining(",")))
                .build());
  ...
  public static QuipThread[] searchThreads(String query, Integer count, Boolean isOnlyMatchTitles)
      throws Exception {
  ...
  public static QuipThread createDocument(
      String title, String content, String[] memberIds, Format format, Type type) throws Exception {
    Form form = Form.form();
  ...
  public static QuipThread createChat(String title, String message, String[] memberIds)
      throws Exception {
    Form form = Form.form();
    if (title != null) form.add("title", title);
  ...
  public QuipThread copyDocument(
      String title, String values, String[] memberIds, String[] folderIds) throws Exception {
  ...
  public boolean editDocument(
      String content, Format format, Location location, String sectionIdOrDocumentRange)
      throws Exception {
    Form form = Form.form().add("thread_id", getId());
    if (format != null) form.add("format", format._value);
    if (content != null) form.add("content", content);
    ...
    if (sectionIdOrDocumentRange != null) {
      if (location == Location.AFTER_SECTION
          ...
          || location == Location.DELETE_SECTION) form.add("section_id", sectionIdOrDocumentRange);
  ...
  public boolean createLivePasteSection(
      String sourceThreadId,
      Boolean isDocumentRangeSource,
      String[] sourceSectionIdsOrDocumentRange,
      Location location,
    ...
    if (isDocumentRangeSource != null)
      form.add("is_document_range_source", String.valueOf(isDocumentRangeSource));
    if (sourceSectionIdsOrDocumentRange != null)
      form.add(
          isDocumentRangeSource ? "source_document_range" : "source_section_ids",
          Stream.of(sourceSectionIdsOrDocumentRange).collect(Collectors.joining(",")));
    if (location != null) {
  ...
  public void delete() throws Exception {
    _postToJsonObject(
        QuipAccess.ENDPOINT + "/threads/delete", Form.form().add("thread_id", getId()));
  }
  ...
  public void lockEdits(Boolean isEditsDisabled) throws Exception {
    _postToJsonObject(
        QuipAccess.ENDPOINT + "/threads/lock-edits",
        Form.form()
            .add("thread_id", getId())
  ...
  public void lockSectionEdits(String sectionId, Boolean isEditsDisabled) throws Exception {
    _postToJsonObject(
        QuipAccess.ENDPOINT + "/threads/lock-section-edits",
        Form.form()
            .add("thread_id", getId())
  ...
  public static QuipThread importFile(File file, Type type, String title, String[] memberIds)
      throws Exception {
    ...
    return new QuipThread(
        _postToJsonObject(QuipAccess.ENDPOINT + "/threads/import-file", multipart));
  }
  ...
  public String createExportPdfRequest(String destinationThreadId) throws Exception {
    ...
    JsonObject json =
        _postToJsonObject(QuipAccess.ENDPOINT + "/threads/" + getId() + "/export/pdf/async", form);
  ...
  public QuipMessage[] getRecentMessages(
      Integer count, Instant maxCreatedUsec, MessageType messageType) throws Exception {
    List<NameValuePair> params = new ArrayList<>();
    if (count != null) params.add(new BasicNameValuePair("count", String.valueOf(count)));
  ...
  public boolean editShareLinkSettings(
      Mode mode,
      Boolean allowExternalAccess,
      Boolean showConversation,
      Boolean showEditHistory,
      Boolean allowMessages,
      Boolean allowComments,
      Boolean enableRequestAccess)
      throws Exception {
    Form form = Form.form().add("thread_id", getId());
    ...
    JsonObject json =
        _postToJsonObject(QuipAccess.ENDPOINT + "/threads/edit-share-link-settings", form);
